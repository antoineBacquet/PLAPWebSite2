...
class CCPConfig
{
    ...
    public static $redirectUrl =  "http://plapcorp.com/ccpcallback";
//public static $redirectUrl =  "http://localhost/ccpcallback";
    ...
    public static $redirectUrlAPI =  "http://plapcorp.com/profile/ccpcallback";
